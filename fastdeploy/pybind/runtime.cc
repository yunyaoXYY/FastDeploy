...
void BindRuntime(pybind11::module& m) {
  pybind11::class_<RuntimeOption>(m, "RuntimeOption")
      ...
      .def("set_lite_nnadapter_model_cache_buffer", &RuntimeOption::SetLiteNNAdapterModelCacheBuffers)
      .def("set_lite_nnadapter_subgraph_partition_config_buffer", &RuntimeOption::SetLiteNNAdapterSubgraphPartitionConfigBuffer)
      .def("set_lite_nnadapter_mixed_precision_quantization_config_buffer", &RuntimeOption::SetLiteNNAdapterMixedPrecisionQuantizationConfigBuffer)
